...
--conf spark.driver.extraClassPath=$OAP_ENV/oap_jars/gazelle-plugin-1.5.0-spark-3.2.1.jar \
  ...
  --conf spark.executor.extraClassPath=$OAP_ENV/oap_jars/gazelle-plugin-1.5.0-spark-3.2.1.jar \
