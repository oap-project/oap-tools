...
OAP_ENV=/opt/home/conda/envs/oap-1.4.0

sh ../spark/spark-shell-client.sh --conf spark.executor.instances=1 \
--conf spark.driver.extraClassPath=$OAP_ENV/oap_jars/gazelle-plugin-1.4.0-spark-3.2.1.jar \
  ...
  --conf spark.executor.extraClassPath=$OAP_ENV/oap_jars/gazelle-plugin-1.4.0-spark-3.2.1.jar \
