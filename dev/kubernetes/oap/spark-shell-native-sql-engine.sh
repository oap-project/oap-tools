...
OAP_ENV=/opt/home/conda/envs/oap-1.1.1

sh ../spark/spark-shell-client.sh --conf spark.executor.instances=1 \
--conf spark.driver.extraClassPath=$OAP_ENV/oap_jars/spark-columnar-core-1.1.1-jar-with-dependencies.jar:$OAP_ENV/oap_jars/spark-arrow-datasource-standard-1.1.1-jar-with-dependencies.jar \
  ...
  --conf spark.executor.extraClassPath=$OAP_ENV/oap_jars/spark-columnar-core-1.1.1-jar-with-dependencies.jar:$OAP_ENV/oap_jars/spark-arrow-datasource-standard-1.1.1-jar-with-dependencies.jar \
